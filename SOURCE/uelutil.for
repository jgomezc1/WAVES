...
C       Computes B matrix.
        ...
        CALL STDM8(NNODE,NDOFEL,NTENS,COORDS,MCRD,B,DDET,RII,SII,
     1             XBAR)
        SMT=SMT+RO*DDET*XBAR*ALF
...
C       Computes B matrix.
        ...
        CALL STDM6(NNODE,NDOFEL,NTENS,COORDS,MCRD,B,DDET,RII,SII,
     1             XBAR)
        SMT=SMT+RO*DDET*XBAR*ALF
...
C       Computes B matrix.
        ...
        CALL STDM4(NNODE,NDOFEL,NTENS,COORDS,MCRD,B,DDET,RII,SII,
     1             XBAR)
        SMT=SMT+RO*DDET*XBAR*ALF
