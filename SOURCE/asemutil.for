...
C23456789012345678901234567890123456789012345678901234567890123456789012
     ...
     4                       LM,ID,IDPL,NPL,ITPL,NEQ,IOUT,
...
C
     ...
     4				  NPL,ITPL,NEQ,IOUT,DT,NINCR,KINC,NMELNOD,
...
C23456789012345678901234567890123456789012345678901234567890123456789012
     ...
     4                    LM,IDPL,VLOADS,NPL,ITPL,NEQ,IOUT,DT,NINCR,
     5					  KINC,NMELNOD,NPINCO,LINCO,DINCO)
...
C           
C       IF (JK .NE. 0) THEN
C           UTMAST(JK)=DT*DT*FORCE(IK)/AMASS(IK)
C       END IF
C           
C     END DO
...
C$OMP PARALLEL DO PRIVATE(K)
     ...
     4                IDPL,VLOADS,NPL,ITPL,NEQ,IOUT,DT,NINCR,KINC,AG,VG,
...
C23456789012345678901234567890123456789012345678901234567890123456789012
     ...
     3                    NMPR,NIMTP,NIPR,AMATE,IMTEI,AWAVE,IWAVE,COORD,
     4                    LM,IDPL,VLOADS,NPL,ITPL,NEQ,IOUT,DT,NINCR,
     5                    KINC,AG,VG,NMELNOD,NPINCO,LINCO,DINCO)
