// Inputs
	...
	Point(2) = { squareSide/2, -squareSide/2, 0, gridsize};//-meshThickness/2, gridsize};
	Point(3) = { squareSide/2,  squareSide/2, 0, gridsize};//-meshThickness/2, gridsize};
	Point(4) = {-squareSide/2,  squareSide/2, 0, gridsize};//-meshThickness/2, gridsize};
