...
Point(30) = {l/2-l5     , hest       , 0, cl4};
Point(31) = {l/2-l5     , hbox       , 0, cl4};
Point(32) = {l/2+l5     , hbox       , 0, cl4};
Point(33) = {l/2+l5     , hest       , 0, cl4};
...
Line Loop(7) = {-45, -49, -48, -47, -43, -7, -6, -5};
Plane Surface(7) = {7};
...
Physical Surface(4000) = {10, 11, 16, 18, 14, 15};  //Estrato
Physical Surface(5000) = {9 ,17};                   //Valle
