...
Point(24) = {l/2        , 0          , 0, cl4};
Point(25) = {(l+lbox)/2 , 0          , 0, cl4};
Point(26) = {(l+lbox)/2 , hest       , 0, cl4};
Point(27) = {(l+lbox)/2 , hbox       , 0, cl4};
Point(28) = {(l-lbox)/2 , hbox       , 0, cl4};
Point(29) = {(l-lbox)/2 , hest       , 0, cl4};
...
Physical Surface(4000) = {8, 9, 12, 14};                  //Estrato
...
Physical Line(4) = {2, 39, 32, 33, 41, 8};
