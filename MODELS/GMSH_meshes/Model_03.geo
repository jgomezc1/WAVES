...
Point(19) = {l/2-3*l4/2, 0    , 0, cl };
Point(20) = {l/2-l4/2  , h5   , 0, cl };
Point(21) = {l/2+l4/2  , h5   , 0, cl };
Point(22) = {l/2+3*l4/2, 0    , 0, cl };
...
Line Loop(8) = {25, 26, 27, 28, 29, -5, -4, -3};
Plane Surface(8) = {8};
...
Physical Line(3) = {1, 2, 25, 26, 27, 28, 29, 6, 7};
