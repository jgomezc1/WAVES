...
# Domain elements.
#
nfin , els1_array  = msw.ele_writer(cells , cell_data , 'quad9' , 20000 , 3 , 1 , 18 , 9 , 0 )
nini = nfin
nfin , els2_array  = msw.ele_writer(cells , cell_data , 'quad9' , 10000 , 3 , 2 , 18 , 9 , nini )
nini = nfin
#
#%%
...
with open('estrato.inp', 'w') as file:
